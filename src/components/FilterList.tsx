...
export default function FilterList({ search, setSearch, genre, setGenre, original_language, setoriginal_language, year, setYear, setSortBy }: FilterListProps) {
    ...
    return (
        <div className="FiltersTab">
            <div className='filters'>
                Year:
                <input type="nuember" value={year} onChange={(e) => {
